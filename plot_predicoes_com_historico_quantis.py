...
PRED_PATH = os.path.join(BASE_PATH, "predicoes_TFT_v17_ibge.csv")
OUT_DIR = os.path.join(BASE_PATH, "graficos_predicoes_quantis")
...
df_hist = df_hist.groupby(["PA_PROC_ID", "PROC_DESCR", "Ano", "Mes"]).agg(
...
filtro = (df_pred["PA_PROC_ID"] == proc_id) & (df_pred["Ano"] == 2025) & (df_pred["Mes"] == 2)
valor = df_pred.loc[filtro, "Valor_Previsto_Mediana"]
...
for proc in procedures:
    hist = df_hist[df_hist["PA_PROC_ID"] == proc]
    pred = df_pred[df_pred["PA_PROC_ID"] == proc]
